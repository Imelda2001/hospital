...
<html lang="en">
	<head>
		<title>Clinique LA GRACE | Login Docteur </title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.php">	<h2>Clinique LA GRACE | Login Docteur</h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
					<span class="text-bold text-uppercase"> Système de Gestion | Clinique LA GRACE</span>
					</div>
