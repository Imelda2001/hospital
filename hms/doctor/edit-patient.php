...
<html lang="en">
	<head>
		<title>Doctor | Ajouter un Patient</title>
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="Female" checked="true">Femme
              <input type="radio" name="gender" id="gender" value="male">Homme
              <?php } else { ?>
              <label>
              <input type="radio" name="gender" id="gender" value="Male" checked="true">Homme
