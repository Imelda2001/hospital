...
<html lang="en">
	<head>
		<title>Docteur | Gerer les Patients</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Docteur | Gerer les Patients</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Docteur</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Gerer <span class="text-bold">les Patients</span></h5>
<?php
                               $vid=$_GET['viewid'];
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  <tr align="center">
   <th colspan="8" >Historique Medical</th> 
  </tr>
  <tr>
    <th>#</th>
<th>Pression Sanguine </th>
<th>Poids </th>
<th>Taux de sucre </th>
<th>Temperature</th>
<th>Prescription Medicale</th>
...
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Ajouter un Historique Medical </button></p>  
  ...
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Ajouter un Historique Medical</h5>
