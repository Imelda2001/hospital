...
<head>
    ...
    <title> Système de Gestion de la Clinique LA GRACE </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:22px; margin-top: 1% !important;">Clinique LA GRACE
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="hms/user-login.php">Reserver un RDV </a>
                    </div>
                </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Système de Gestion de la Clinique LA GRACE </h5>
                        ...
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="hms/user-login.php" target="_blank">
                                    <button class="btn btn-success btn-sm">Cliquer ici</button>
                                </a>
                            </div>
                        </div>
                    </div>
...
?>
    ...
    <div class="copy">
            <div class="container">
         Système de Gestion de la Clinique LA GRACE 
